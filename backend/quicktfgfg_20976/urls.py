"""quicktfgfg_20976 URL Configuration
...
admin.site.site_header = "quicktfgfg"
admin.site.site_title = "quicktfgfg Admin Portal"
admin.site.index_title = "quicktfgfg Admin"

# swagger
api_info = openapi.Info(
    title="quicktfgfg API",
    default_version="v1",
    description="API documentation for quicktfgfg App",
)
